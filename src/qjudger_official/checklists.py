...
# Это даёт байт-в-байт совпадающий с оригинальным judge.py промпт/чеклисты,
# на которых был валидирован Q-Judger (Spearman rho=0.92 с человеческими
# экспертами, см. README §6.2 этого проекта). 
# ============================================================================
